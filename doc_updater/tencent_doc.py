...
class TencentDocUpdater:
    def __init__(self, doc_url, cookies=None):
        profile_path = "/home/hxy/snap/firefox/common/.mozilla/firefox/2njivqga.default" # todo: 替换为实际的Firefox配置文件路径
        profile = FirefoxProfile(profile_path)
        options = Options()
        self.driver = webdriver.Firefox(
            firefox_profile=profile,
            options=options,
            executable_path="/snap/bin/geckodriver" # todo: 替换为实际的geckodriver路径
        )
        time.sleep(5)
